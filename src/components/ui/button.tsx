...
const buttonVariants = cva(
  [
    ...
    "transition-all focus-visible:border-gray-950 focus-visible:ring-[3px] focus-visible:ring-gray-950/50 disabled:pointer-events-none",
  ...
  ],
  {
    variants: {
      variant: {
        default: "bg-gray-900 text-gray-50 shadow-xs hover:bg-gray-900/90",
