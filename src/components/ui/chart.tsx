    ...
    <ChartContext.Provider value={{ config }}>
      <div
        className={cn(
          ...
          "[&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-border/50 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-border",
          "[&_.recharts-dot[stroke='#fff']]:stroke-transparent [&_.recharts-layer]:outline-hidden [&_.recharts-polar-grid_[stroke='#ccc']]:stroke-border",
              ...
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <>
                  ...
                  >
                    ...
                    {item.value && (
                      <span className="font-medium font-mono text-gray-950 tabular-nums">
