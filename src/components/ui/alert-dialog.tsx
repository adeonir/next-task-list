    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        className={cn(
          ...
          "translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border border-gray-200 bg-white p-6 shadow-lg",
          "duration-200 data-[state=closed]:animate-out data-[state=open]:animate-in sm:max-w-lg",
          className,
        )}
